                            ...
                            with patch.object(RateLimiter, 'get_rule_by_service_id') as get_rule_by_service_id_mock:
                                with patch.object(Error, 'handle') as handle_mock:
                                    with patch.object(Bson, 'to_json') as to_json_mock:
                                        ...
                                        expect(
                                            get_rule_by_id_mock.call_args[0][0]).to(
                                            equal(
                                                mock_query['id']))
                                        ...
                                        expect(
                                            get_rule_by_status_code_mock.call_args[0][0]).to(
                                            equal(
                                        ...
                                        expect(
                                            get_rule_by_service_id_mock.call_args[0][0]).to(
                                            equal(
                            ...
                            with asynctest.patch.object(RateLimiter, 'get_entry_by_host') as get_entry_by_host_mock:
                                with patch.object(Error, 'handle') as handle_mock:
                                    with patch.object(Bson, 'to_json') as to_json_mock:
                                        ...
                                        expect(
                                            get_entry_by_id_mock.call_args[0][0]).to(
                                            equal(
                                                mock_query['id']))
                                        get_mock.assert_called()
                                        ...
                                        expect(
                                            get_entry_by_rule_id_mock.call_args[0][0]).to(
                                            equal(
                                                mock_query['rule_id']))
                                        get_mock.assert_called()
                                        ...
                                        expect(
                                            get_entry_by_host_mock.call_args[0][0]).to(
                                            equal(
                                                mock_query['host']))
                                        get_mock.assert_called()
